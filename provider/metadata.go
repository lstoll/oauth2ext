...
// OIDCProviderMetadata implements the JSON structure that describes the
...
func (m *OIDCProviderMetadata) authorizationEndpoint() string {
	return m.AuthorizationEndpoint
}

func (m *OIDCProviderMetadata) tokenEndpoint() string {
	return m.TokenEndpoint
}

func (m *OIDCProviderMetadata) userinfoEndpoint() string {
