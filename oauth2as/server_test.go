...
// mockTokenRequest creates a mock http.Request for testing token endpoints
func mockTokenRequest() *http.Request {
...
func TestCodeToken(t *testing.T) {
	...
	t.Run("Happy path", func(t *testing.T) {
		...
		tresp, err := o.codeToken(context.TODO(), mockTokenRequest(), treq)
		if err != nil {
	...
	t.Run("Redeeming an already redeemed code should fail", func(t *testing.T) {
		...
		_, err := o.codeToken(context.Background(), mockTokenRequest(), treq)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
	...
	t.Run("Response access token validity time honoured", func(t *testing.T) {
		...
		tresp, err := o.codeToken(context.Background(), mockTokenRequest(), treq)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
...
func TestRefreshToken(t *testing.T) {
	...
	t.Run("Refresh token happy path", func(t *testing.T) {
		...
		for i := 1; i <= 5; i++ {
			...
			tresp, err := o.refreshToken(context.Background(), mockTokenRequest(), treq)
			if err != nil {
		...
		_, err := o.refreshToken(context.Background(), mockTokenRequest(), treq)
